...
# -*- coding: utf-8 -*-
#
# Turkish ID Verification Client for KPS Public Service
#
...
def query(id, name, surname, birth_year):
    ...
    response = requests.post('https://tckimlik.nvi.gov.tr/Service/KPSPublic.asmx', data=element_str, headers=headers).text
